...
function PaymentsPostedForm({ initialContents, submitAction, buttonLabel = "Create" }) {
        ...
        <Form onSubmit={handleSubmit(submitAction)}>
            ...
            {initialContents && (
                    <Col>
                        <Form.Group className="mb-3" >
                            ...
                            <Form.Control
                                data-testid="PaymentsPostedForm-id"
                                id="id"
                                type="text"
                                {...register("id")}
            ...
            <Row>
                <Col>
                    <Form.Group className="mb-3" >
                        ...
                        <Form.Control
                            data-testid="PaymentsPostedForm-amount"
                            id="amount"
                            type="number"
                            {...register("amount")}
                            value={initialContents.amount}
                            disabled
                        />
            ...
            {initialContents && (
                    <Col>
                        <Form.Group className="mb-3" >
                            ...
                            <Form.Control
                                data-testid="PaymentsPostedForm-initialTime"
                                id="initialTime"
                                type="number"
                ...
                <Form.Group className="mb-3" >
                        ...
                        <Form.Control
                            data-testid="PaymentsPostedForm-finalizedTime"
                            id="finalizedTime"
                            type="number"
            ...
            <Row>
                <Col>
                    <Button
                        type="submit"
                        data-testid="PaymentsPostedForm-submit"
                    >
                        {buttonLabel}
                    </Button>
                    <Button
                        variant="Secondary"
                        onClick={() => navigate(-1)}
                        data-testid="PaymentsPostedForm-cancel"
                    >
                        Cancel
                    </Button>
                </Col>
...
export default PaymentsPostedForm;
